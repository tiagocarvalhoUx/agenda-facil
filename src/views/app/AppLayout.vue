...
const allItems: NavItem[] = [
  ...
  { name: 'reativacao', label: 'Reativação por IA', short: 'Reativar', icon: Sparkles, ownerOnly: true },
  { name: 'meus-links', label: 'Meus Links Públicos', short: 'Links', icon: Link2, ownerOnly: true },
